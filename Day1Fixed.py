...
DataOut.
The code will then print Dataout to the console on it's own. You need to do three things.
...
3. Perform mean on all columns and write this as DataOut. run it

4. Do the same to all rows. run it

5. Try a historgram. run it
...
4. Do this analysis without visually inspecting the data first. Remember 
...
# Intialization code:
InFile=Directory+"//"+"SampleData1.csv" # If this line fails, go back up to line 79 and add an r
